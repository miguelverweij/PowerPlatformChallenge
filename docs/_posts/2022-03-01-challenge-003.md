...
For those who did not try [CHALLENGE 002](/_posts/2022-02-01-challenge-002.md) yet, I can highly recommend taking that one fist. 
...
That's it for now. At this moment the app will only show the challenges, but will not have add/edit/delete functionality. That will be our additional feature in version 2.
...
Because you already conducted [CHALLENGE 002](docs/_posts/2022-02-01-challenge-002.md), you should already have a GitHub acount. If not, check how to get one there.
...
The pipeline is now fully operational. You can further develop the solution in the development environment. Based on the solution we created at the beginning you could think of adding and editing records as additional features to your solution. Build whatever suits you. Once you have added these new features in the development environment, use the Github Actions to get the new version to the production environment.
